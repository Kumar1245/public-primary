...
_Generated: 2026-05-12T17:40:56.723Z_
...
Workspace `mcp.json` _(folder: Public-primary-web)_

- **c:\Users\mspra\OneDrive\Desktop\All Frontend\Public-primary-web\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\mspra\.claude.json** — _File exists — no servers defined_
